...
const ChatHeader = () => {
  const { userInfo, closeChat, selectedChatData,selectedChatType } = useAppStore();
  return (
          ...
          <div className="w-12 h-12 relative">
            <Avatar className="h-12 w-12  rounded-full overflow-hidden">
              {selectedChatData.image ? (
                <AvatarImage src={`http://localhost:1021/${selectedChatData.image}`} alt="profile" className="object-cover w-full h-full bg-black" />
              ) : (
